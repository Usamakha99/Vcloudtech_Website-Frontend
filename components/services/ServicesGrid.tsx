...
export const SERVICES_GRID_ITEMS: ServiceItem[] = [
  {
    ...
    description: "Providing fast, reliable access to the AI infrastructure your business depends on.",
    href: "/solutions/ai-infrastructure-procurement",
    icon: ServerIcon,
    image: serviceImages.aiProcurement,
    imagePosition: "6% 16%",
    bullets: [
      "Enterprise-grade GPUs, AI servers, and intelligent accelerators",
      "Global sourcing through strategic technology partnerships",
      "Infrastructure planning aligned with your AI workloads",
      "Scalable, cost-effective procurement for long-term growth",
    ],
  },
  {
    title: "Data Center Hardware",
    description: "Delivering dependable compute and storage for business-critical environments.",
    href: "/solutions/data-center-hardware",
    icon: ServerIcon,
    image: serviceImages.dataCenterHardware,
    imagePosition: "5% 18%",
    bullets: [
      "Enterprise-grade servers, storage, and high-performance computing",
      "Rack integration and data center infrastructure",
      "Expert staging, configuration, and deployment services",
      "Scalable hardware designed for future growth",
    ],
  },
  {
    title: "Networking",
    description:
      "High-performance networking that keeps your enterprise secure, connected, and always available.",
    href: "/solutions/data-center-networking",
    icon: CloudIcon,
    image: serviceImages.networking,
    imagePosition: "6% 5%",
    bullets: [
      "Enterprise switching, routing, and wireless infrastructure",
      "SD-WAN and next-generation network architecture",
      "Optimized for performance, resilience, and availability",
      "Proactive monitoring, management, and ongoing support",
    ],
  },
  {
    title: "Cybersecurity",
    description: "Enterprise cybersecurity designed to protect your most critical assets and data.",
  ...
  },
  {
    ...
    description: "Reliable power and cooling solutions designed for uninterrupted business continuity.",
    href: "/solutions/power-infrastructure",
    icon: CartIcon,
    image: serviceImages.powerInfrastructure,
    imagePosition: "5% 14%",
    bullets: [
      "UPS systems, backup power, and power distribution",
      "Intelligent rack-level power management",
      "Precision cooling and environmental monitoring",
      "Built for maximum resilience and continuous uptime",
    ],
  },
  {
    title: "Lifecycle Management",
    description: "Maximizing the value of your technology from deployment to retirement.",
    href: "/solutions/lifecycle-management",
    icon: ContractIcon,
    image: serviceImages.lifecycleManagement,
    imagePosition: "8% 18%",
    bullets: [
      "Asset lifecycle management and technical support",
      "Infrastructure upgrades and refresh planning",
      "Continuous performance monitoring and optimization",
      "Secure decommissioning and IT asset disposition",
    ],
  },
];
