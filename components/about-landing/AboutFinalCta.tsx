...
/** About page closing CTA — same shell and spark animation as home Meet Our Experts. */
    ...
    >
      ...
      <div className="dt-experts-cta__inner">
        <DtScrollReveal className="dt-experts-cta__content">
          ...
          <h2 id="about-cta-heading" className={`${dt.sectionHeadline} mt-6 text-white sm:mt-7`}>
            {aboutCta.title}
          </h2>
          <p className={`mx-auto mt-3 max-w-2xl text-sm sm:text-base ${dt.body}`}>{aboutCta.lede}</p>
