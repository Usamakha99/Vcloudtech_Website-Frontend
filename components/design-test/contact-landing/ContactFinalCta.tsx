...
/** Contact page closing CTA — same shell and spark animation as home Meet Our Experts. */
    ...
    >
      ...
      <div className="dt-experts-cta__inner">
        <DtScrollReveal className="dt-experts-cta__content">
          ...
          <h2 id="contact-final-cta-heading" className={`${dt.sectionHeadline} mt-6 text-white sm:mt-7`}>
            Ready to Transform Your IT Infrastructure?
          </h2>
          <p className={`mx-auto mt-3 max-w-2xl text-sm sm:text-base ${dt.body}`}>
            Speak with our enterprise team about AI infrastructure, procurement, and managed technology
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="#contact-form"
              className="dt-experts-cta__button inline-flex h-12 items-center justify-center rounded-full px-8 text-sm font-semibold transition duration-300"
            >
              Schedule Consultation
            </Link>
            <Link
              href={`mailto:${designTestContactInfo.email}`}
              className="contact-page__btn-secondary inline-flex h-12 items-center justify-center rounded-full px-8 text-sm font-semibold transition duration-300"
            >
              Contact Our Team
            </Link>
          </div>
