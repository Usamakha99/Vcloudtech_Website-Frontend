...
export const dt = {
  badge:
    "inline-block rounded-full border border-orange-500/30 bg-orange-500/10 px-4 py-1.5 text-[10px] font-semibold uppercase tracking-[0.2em] text-white/90 sm:text-[11px]",

  sectionBorder: "border-t border-orange-500/10",

  headingSub: "text-white/60",
  ...
  iconBox:
    "flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-orange-500/10 text-white ring-1 ring-orange-400/25",

  iconBoxLg:
    "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-orange-500/10 text-white ring-1 ring-orange-400/25",

  iconBoxSm:
    "flex h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-orange-500/10 text-white ring-1 ring-orange-400/25",

  /** Unified card icon — same size & SVG scale across lab sections */
  iconBoxCard:
    "flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-orange-500/10 text-white ring-1 ring-orange-400/25 sm:h-12 sm:w-12 [&_svg]:h-5 [&_svg]:w-5 sm:[&_svg]:h-[22px] sm:[&_svg]:w-[22px]",

  accentDash: "inline-block h-px w-6 bg-orange-500/80",

  link: "text-white/90 transition hover:text-white",

  linkSm: "text-[12px] font-medium text-white/90 transition hover:text-white",

  statValue: "text-white",

  statValueAlt: "text-white",

  statLabel: "text-white/65",

  body: "text-white/75",

  number: "font-mono text-[11px] tabular-nums tracking-wider text-white/35",

  tag:
    "rounded-full border border-orange-400/25 bg-orange-500/10 px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-white/90",
  ...
  certPill:
    "inline-flex items-center rounded-md border border-orange-500/20 bg-orange-500/5 px-2.5 py-1 text-[10px] font-semibold uppercase tracking-wider text-white/90 sm:px-3 sm:py-1.5 sm:text-[11px]",
  ...
  glassLink: "text-white/90 group-hover/card:text-white",
  ...
  stackMeta: "text-[11px] font-medium uppercase tracking-[0.14em] text-white/70",

  stackTitle: "text-base font-semibold leading-snug tracking-tight text-white sm:text-[17px]",

  stackBody: "mt-2 text-[13px] leading-relaxed text-white/55 sm:text-sm",
